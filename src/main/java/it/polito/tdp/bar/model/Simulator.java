...
// Conto i clienti totali
			this.statistica.incrementaClienti(e.getnPersone());
...
// Cerco un tavolo
			...
			if(tavolo!=null)
			{
				...
				statistica.incrementaInsoddisfatti(e.getnPersone());
...
// si fermano al bancone
					statistica.incrementaSoddisfatti(e.getnPersone());
					System.out.format("%d persone si fermano ", e.getnPersone());
				}
				else
				{
// NON si fermano
					statistica.incrementaInsoddisfatti(e.getnPersone());
					System.out.format("%d persone NON si fermano ", e.getnPersone());
				}
			}
			break;
